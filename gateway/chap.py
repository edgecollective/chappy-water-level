    ...
    if packet is not None:
        ...
        try:
            ...
            if len(pl)==4:
                ...
                base_humid=bme280.humidity
                base_temp=bme280.temperature
                base_pressure=bme280.pressure
                base_altitude=bme280.altitude
                ...
                delta_P = (float(pressure)-float(base_pressure))*100. # convert to Pascals from mbar
                density = 1029.0 # density of seawater in kg/m^3
                g = 9.98 # m / s^2
                height = float(delta_P / (density * g)) # in meters
                print("height=",height)
                json_data = {"height":height, "base_temp" : base_temp, "base_humid" : base_humid, "base_pressure" : base_pressure, "base_altitutde": base_altitude, "temp" : temp,"pressure" : pressure, "depth" : depth, "batt": batt}
